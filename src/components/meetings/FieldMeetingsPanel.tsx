  ...
  return (
    <div className="space-y-5">
      <p className="text-sm text-muted-foreground">
        {isSuper
          ? "Defina os turnos e a modalidade. O Local da Reunião de Campo é obrigatório e preenchido pelos anciãos."
          : "Preencha os dados de cada turno. O campo Local da Reunião de Campo é obrigatório."}
      </p>
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <div className="col-span-2">
            <label className="text-[11px] uppercase tracking-wide text-muted-foreground font-medium">
              Local da Reunião de Campo <span className="text-destructive">*</span>
            </label>
            <Input
