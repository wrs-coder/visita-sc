...
type ElderProgramData = NonNullable<Snapshot["elderProgram"]>;
type ElderSectionKey = keyof typeof ELDER_SECTION_TITLES;

function ElderProgramReadOnly({ data }: { data: ElderProgramData | null }) {
  if (!data) {
    return (
      <Card>
